...
class s2class_upgrade {
	...
	function upgrade64() {
		...
		$mysubscribe2->subscribe2_options['mailtext_update'] = preg_replace($regex, $replace, $mysubscribe2->subscribe2_options['mailtext_update']);
		...
		$mysubscribe2->subscribe2_options['notification_subject_update'] = preg_replace($regex, $replace, $mysubscribe2->subscribe2_options['notification_subject_update']);
