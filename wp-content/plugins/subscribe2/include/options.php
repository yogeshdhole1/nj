...
if (!isset($this->subscribe2_options['mailtext_update'])) {
	$this->subscribe2_options['mailtext_update'] = __("{BLOGNAME} has posted a new item, '{TITLE}'\n\n{POST}\n\nYou may view the latest post at\n{PERMALINK}\n\nYou received this e-mail because you asked to be notified when new updates are posted.\nBest regards,\n{MYNAME}\n{EMAIL}", "subscribe2");
} // Default notification email text
...
if (!isset($this->subscribe2_options['notification_subject_update'])) {
	$this->subscribe2_options['notification_subject_update'] = "[{BLOGNAME}] {TITLE}";
} // Default notification email subject
